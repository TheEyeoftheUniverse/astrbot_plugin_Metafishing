"""迁移 015：幂等重放卡池鱼饵与 shop5-8 一次性通行证静态数据。"""
...
def up(cursor: sqlite3.Cursor) -> None:
    ...
    cursor.executemany(
        ...
        """,
        (
            (129, 5, "工厂污染区域通行证", "你被允许前往该海域的放行理由是能通过钓鱼净化水质。"),
            (130, 6, "化龙碎片", "化为龙的鲤鱼褪下的残壳碎片。"),
            (131, 7, "千面碎片", "千百种生物皮肤的细小碎片。"),
            (132, 8, "龙窟金币", "因沾染到龙息，有些许融化的普通金币。"),
        ),
    )
