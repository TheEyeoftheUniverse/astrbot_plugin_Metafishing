...
-- table: aquarium_income_pending
CREATE TABLE aquarium_income_pending (
            user_id TEXT NOT NULL,
...
-- index: idx_aquarium_income_pending_user_unclaimed
CREATE INDEX idx_aquarium_income_pending_user_unclaimed ON aquarium_income_pending(user_id) WHERE claimed_at IS NULL;
